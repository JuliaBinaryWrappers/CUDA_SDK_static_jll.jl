# `CUDA_SDK_static_jll.jl` (v13.0.2+2)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/977a7eda957c79b7ab8140de38b960b64e36e636/C/CUDA/CUDA_SDK_static@13.0/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
